...
class Environment:
    ...
    def do(self, state, action):
        ...
        if new_state not in self.__states \
                or self.__states[new_state] in [MAP_OUTSIDE, MAP_WALL, MAP_START,MAP_CHECK]:
...
class Agent:
    def __init__(self, env, alpha=1, gamma=0.7):
        self.__qtable = {}
